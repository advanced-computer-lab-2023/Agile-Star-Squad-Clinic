...
exports.updateAppointment = catchAsync(async (req, res, next) => {
  ...
  const pMessage = `Your appointment with doctor ${doctor.name} has been rescheduled to be at ${req.body.dateOfAppointment}`
  const dMessage = `Your appointment with patient ${patient.name} has been rescheduled to be at ${req.body.dateOfAppointment}`
