...
export default function CheckoutForm(props) {
  ...
  return (
    <form id="payment-form" onSubmit={onSubmit}>
      ...
      <select  className={styles.input1} value={selectedCity} onChange={handleCityChange}>
      ...
      <div className="d-flex flex-row justify-content-between">
        <div style={{ display: 'flex', marginLeft: '65px' }}>
          <div className={styles.me3} style={{ marginLeft: '0px' }}>
            <img
              className={`${styles.hellokitty} ${useWallet === 0 ? 'active' : ''}`}
              src="/cc.png"
          ...
          <div className={styles.me3} style={{ paddingLeft: '40px' }}>
            ...
            <img
              className={`${styles.hellokitty} ${useWallet === 2 ? 'active' : ''}`}
              src="/cod.png"
          ...
          <div className={styles.me3} style={{ paddingLeft: '40px' }}>
            <img
              className={`${styles.hellokitty} ${useWallet === 1 ? 'active' : ''}`}
              src="/wallet.png"
