        ...
        <div className={classes.wrapper}>
            ...
            <div className={classes.tableWrapper}>
                <div className={classes.tableOptions}>
                    <div className={filterIndex == 0 ? classes.optionEnabled : classes.option} onClick={() => handleFilterChange(0)}>All Prescriptions</div>
                    <div className={`${filterIndex == 1 ? classes.optionEnabled : classes.option} position-relative`} onClick={() => handleFilterChange(1)}>
                        {pickedDoctor}
                        <Select
                            options={prescriptionDoctors.map(doc => { return { label: doc } })}
                            styles={customStyles}
                    ...
                    <div className={`${classes.filledButton} ${statusFilter === 1 ? classes.filledEnabled : ""}`} onClick={() => handleStatusChange(1)}>Filled</div>
                    <div className={`${classes.unfilledButton} ${statusFilter === 0 ? classes.unfilledEnabled : ""}`} onClick={() => handleStatusChange(0)}>Unfilled</div>
